...
describe('Checkbox', () => {
    describe('Renders as expected', () => {
        const wrapper = mount(<Checkbox id="testing" labelText="testingLabel" className="extra-class" />)
    ...
    it('disabled prop on component sets disabled prop on input', () => {
        const wrapper = mount(<Checkbox id="test" labelText="testlabel" disabled />)
    ...
    it('hideLabel hides the label visually', () => {
        const wrapper = mount(<Checkbox id="test" labelText="testlabel" hideLabel />)
    ...
    describe('events', () => {
        it('should invoke onChange with expected arguments', () => {
            ...
            const id = 'test-input'
            const wrapper = mount(<Checkbox labelText="testlabel" id={id} onChange={onChange} />)
